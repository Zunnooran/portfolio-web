...
import { Breakpoints, Drawer, Theme } from "@mui/material";
...
function Navbar() {
  const { theme, toggleDrawer } = useThemeContext();
  ...
  const useStyles = makeStyles((t: CustomTheme) => ({
    navMenu: {
      fontSize: "2.5rem",
